...
public class MyMain {
    ...
    public static void testMyStack() {
        ...
        //-------------------------------------
        MyStackHint3<Integer> m1;
        //m1 = my_create_empty(); //--> We cannot create a new myStack using explicitly my_create_empty()
        m1 = new MyDoubleDynamicStack<>(); //--> Instead we choose to follow the implementation class.

        MyStackHint3<Boolean> m2;
        //m1 = my_create_empty(); //--> We cannot create a new myStack using explicitly my_create_empty()
        m2 = new MyDoubleDynamicStack<>(); //--> Instead we choose to follow the implementation class.
